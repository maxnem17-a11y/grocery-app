...
└── larder/                 ← Vite app (now the deployed PWA)
    ...
    └── src/
        ...
        │   └── RecipeModalContext.jsx ← open/close handle for the shared recipe detail modal (2026-06-05)
        └── components/
            ...
            ├── ExpiredBanner.jsx  ← "Use today or bin" banner (expired pantry items + Still good/Used/Binned popover); rendered by App above the tab nav

...
**Last commit:** `7676dbb` — retro polish: VT323 font + chunky borders + pixelated jar in retro brand-style mode. Earlier today: `5f02574` Apps Script expiry digest, `0d03199` Basket→tab 2, `a42047d` `khalilAllergenFlag` cow-milk fix. Live at https://maxnem17-a11y.github.io/grocery-app/.

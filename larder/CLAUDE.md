...
**Last commit:** `5f02574` — `apps-script/{Code.gs, README.md}` for backlog #7 expiry digest (code side; daily trigger setup is laptop-side). Earlier today: `0d03199` Basket→tab 2, `a42047d` `khalilAllergenFlag` cow-milk fix. Live at https://maxnem17-a11y.github.io/grocery-app/.
